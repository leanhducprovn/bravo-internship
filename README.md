...
| 6   | `ngAfterContentChecked()` | Thực thi sau khi Angular đã kiểm tra nội dung bên ngoài đã được đưa vào view của component. Được gọi sauv`ngAfterContentInit()` và mọi `ngDoCheck()` tiếp theo.                                         |
